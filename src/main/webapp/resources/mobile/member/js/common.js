...
(function($) {
	...
	$.fn.infiniteScroll.defaults = {
		...
		sensitivity: 200,
		prefill: true,
		loader: '<div class="infinite-scroll-loading">正在加载中...</div>',
		template: function(pageNumber, data) {},
		finished: function(pageNumber, data) {
			var $element = $(this);
			if (pageNumber > 1 || data.length > 0) {
				$element.append('<div class="infinite-scroll-tips">没有更多记录</div>');
			} else {
				$element.append('<div class="infinite-scroll-tips">没有任何记录</div>');
			}
		}
	};
