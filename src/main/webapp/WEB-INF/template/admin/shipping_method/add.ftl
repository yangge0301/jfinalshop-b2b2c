...
<title>${message("admin.shippingMethod.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="shippingMethod.name" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="shippingMethod.icon" class="text" maxlength="200" />
			...
			<tr>
				...
				<td>
					<input type="text" name="shippingMethod.description" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="shippingMethod.orders" class="text" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
