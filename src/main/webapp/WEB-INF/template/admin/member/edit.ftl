...
<title>${message("admin.member.edit")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="member.email" class="text" value="${member.email}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="member.mobile" class="text" value="${member.mobile}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<select name="storeId">
						[#list stores as store]
							<option value="${store.id}"[#if store == member.store] selected="selected"[/#if]>${store.name}</option>
						[/#list]
					</select>
				</td>
			</tr>
