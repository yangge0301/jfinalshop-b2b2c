...
<title>${message("admin.coupon.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.coupon.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					...
					<li[#if pageable.searchProperty == "store.name"] class="current"[/#if] val="store.name">${message("Coupon.store")}</li>
				</ul>
			</div>
		</div>
