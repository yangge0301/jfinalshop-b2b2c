...
<title>${message("admin.point.log")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.point.log")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="log" method="get">
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "member.username"] class="current"[/#if] val="member.username">${message("PointLog.member")}</li>
				</ul>
			</div>
		</div>
