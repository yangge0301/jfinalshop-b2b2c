...
<title>${message("admin.attribute.edit")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="attribute.name" class="text" value="${attribute.name}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="attribute.orders" class="text" value="${attribute.orders}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
