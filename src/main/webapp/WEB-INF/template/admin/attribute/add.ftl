...
<title>${message("admin.attribute.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="attribute.name" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="attribute.orders" class="text" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
