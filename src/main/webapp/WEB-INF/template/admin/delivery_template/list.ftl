...
<title>${message("admin.deliveryTemplate.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.deliveryTemplate.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
