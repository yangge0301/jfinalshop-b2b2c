...
<title>${message("admin.business.edit")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="business.email" class="text" value="${business.email}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="business.mobile" class="text" value="${business.mobile}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr class="roles">
				...
				<td>
					<span class="fieldSet">
						[#list roles as role]
							<label>
								<input type="checkbox" name="roleIds" value="${role.id}"[#if business.roles?seq_contains(role)] checked="checked"[/#if] />${role.name}
							</label>
						[/#list]
					</span>
				</td>
