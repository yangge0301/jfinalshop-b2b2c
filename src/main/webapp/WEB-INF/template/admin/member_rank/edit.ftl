...
<title>${message("admin.memberRank.edit")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="memberRank.name" class="text" value="${memberRank.name}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="memberRank.scale" class="text" value="${memberRank.scale}" maxlength="7" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="amount" name="memberRank.amount" class="text" value="${memberRank.amount}" maxlength="16"[#if memberRank.isSpecial] disabled="disabled"[/#if] />
				</td>
			</tr>
			<tr>
				<th>
