...
<title>${message("admin.article.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.article.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list" method="get">
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "title"] class="current"[/#if] val="title">${message("Article.title")}</li>
				</ul>
			</div>
		</div>
