...
<title>${message("admin.article.edit")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="article.title" class="text" value="${article.title}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<textarea id="content" name="article.content" class="editor">${article.content}</textarea>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="article.seo_title" class="text" value="${article.seoTitle}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="article.seo_keywords" class="text" value="${article.seoKeywords}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="article.seo_description" class="text" value="${article.seoDescription}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
