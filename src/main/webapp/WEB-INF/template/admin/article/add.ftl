...
<title>${message("admin.article.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="article.title" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="article.author" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<textarea id="content" name="article.content" class="editor"></textarea>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="article.seo_title" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="article.seo_keywords" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="article.seo_description" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
