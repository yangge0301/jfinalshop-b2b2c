...
<title>${message("admin.role.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.role.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list" method="get">
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "name"] class="current"[/#if] val="name">${message("Role.name")}</li>
				</ul>
			</div>
		</div>
