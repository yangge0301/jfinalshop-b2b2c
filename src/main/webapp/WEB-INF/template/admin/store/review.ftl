...
<title>${message("admin.store.review")} - Powered By JFinalShop</title>
...
<body>
	...
	<form id="inputForm" action="save_review" method="post">
			...
			[@business_attribute_list]
				[#list businessAttributes as businessAttribute]
					<tr>
						...
						[#if businessAttribute.typeName == "image" || businessAttribute.typeName == "licenseImage" || businessAttribute.typeName == "idCardImage" || businessAttribute.typeName == "organizationImage" || businessAttribute.typeName == "taxImage"]
							<td>
