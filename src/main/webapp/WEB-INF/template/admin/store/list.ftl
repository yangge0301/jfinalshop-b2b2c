...
<title>${message("admin.store.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.store.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list" method="get">
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "name"] class="current"[/#if] val="name">${message("Store.name")}</li>
					<li[#if pageable.searchProperty == "email"] class="current"[/#if] val="email">${message("Store.email")}</li>
					<li[#if pageable.searchProperty == "mobile"] class="current"[/#if] val="mobile">${message("Store.mobile")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			...
			[#list page.list as store]
				<tr>
					...
					<td>
						<span class="[#if store.statusName == "approved" || store.statusName == "success"]green[#else]red[/#if]">${message("Store.Status." + store.statusName)}</span>
						[#if store.hasExpired()]
