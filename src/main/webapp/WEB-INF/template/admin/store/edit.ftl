...
<title>${message("admin.store.edit")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="store.name" class="text" value="${store.name}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					${message("Store.Type." + store.typeName)}
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="store.logo" class="text" value="${store.logo}" maxlength="200" />
			...
			<tr>
				...
				<td>
					<input type="text" name="store.email" class="text" value="${store.email}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="store.mobile" class="text" value="${store.mobile}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="store.phone" class="text" value="${store.phone}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="store.address" class="text" value="${store.address}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="store.zip_code" class="text" value="${store.zipCode}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<textarea name="store.introduction" class="text">${store.introduction}</textarea>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="store.keyword" class="text" value="${store.keyword}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="store.end_date" class="text Wdate" value="${store.endDate?string("yyyy-MM-dd HH:mm:ss")}" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});" />
				</td>
			</tr>
			<tr>
				<th>
