...
<title>${message("admin.store.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="store.name" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="store.logo" class="text" maxlength="200" />
			...
			<tr>
				...
				<td>
					<input type="text" name="store.email" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="store.mobile" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="store.phone" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="store.address" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="store.zip_code" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<textarea name="store.introduction" class="text"></textarea>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="store.keyword" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
