...
<title>${message("admin.navigation.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" id="name" name="navigation.name" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" id="url" name="navigation.url" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="navigation.orders" class="text" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
