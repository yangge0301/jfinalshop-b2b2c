...
<title>${message("admin.navigation.edit")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" id="name" name="navigation.name" class="text" value="${navigation.name}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" id="url" name="navigation.url" class="text" value="${navigation.url}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<select name="position">
						[#list positions as position]
							<option value="${position}"[#if position == navigation.positionName] selected="selected"[/#if]>${message("Navigation.Position." + position)}</option>
						[/#list]
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="navigation.orders" class="text" value="${navigation.orders}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
