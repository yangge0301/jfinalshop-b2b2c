...
<title>${message("admin.auditLog.view")} - Powered By JFinalShop</title>
...
<body>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				[#if auditLog.parametersConverter?has_content]
					<ul class="parameters">
						[#list auditLog.parametersConverter.entrySet() as entry]
							<li>
