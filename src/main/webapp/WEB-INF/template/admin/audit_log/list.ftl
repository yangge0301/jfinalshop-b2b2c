...
<title>${message("admin.auditLog.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.auditLog.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list" method="get">
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "detail"] class="current"[/#if] val="detail">${message("AuditLog.detail")}</li>
				</ul>
			</div>
		</div>
