...
<title>${message("admin.order.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.order.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					...
					<li[#if page.searchProperty == "area_name"] class="current"[/#if] val="areaName">${message("Order.area")}</li>
					<li[#if page.searchProperty == "address"] class="current"[/#if] val="address">${message("Order.address")}</li>
					<li[#if page.searchProperty == "zip_code"] class="current"[/#if] val="zipCode">${message("Order.zipCode")}</li>
