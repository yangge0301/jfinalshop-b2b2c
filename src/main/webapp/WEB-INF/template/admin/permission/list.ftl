...
<title>${message("admin.permission.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.permission.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list" method="get">
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "name"] class="current"[/#if] val="name">${message("Permission.name")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="createDate">${message("admin.common.createdDate")}</a>
				</th>
				<th>
			...
			[#list page.list as permission]
				<tr>
					...
					<td>
						<span title="${permission.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${permission.createdDate}</span>
					</td>
					<td>
						<a href="edit?id=${permission.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
