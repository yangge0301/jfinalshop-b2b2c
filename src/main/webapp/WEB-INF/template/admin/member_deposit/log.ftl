...
<title>${message("admin.memberDeposit.log")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.memberDeposit.log")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="log" method="get">
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "member.username"] class="current"[/#if] val="member.username">${message("MemberDepositLog.member")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			...
			[#list page.list as memberDepositLog]
				<tr>
					<td>
						${message("MemberDepositLog.Type." + memberDepositLog.typeName)}
					</td>
					<td>
