...
<title>${message("admin.specification.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="specification.name" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="specification.orders" class="text" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<table id="optionTable" class="item">
						...
						[#if sample??]
							[#list sample.optionsConverter as option]
								<tr>
									<td>
