...
<title>${message("admin.setting.edit")} - Powered By JFinalShop</title>
...
$().ready(function() {
	...
	$inputForm.validate({
		rules: {
			...
			"setting.registerPoint": {
				required: true,
				integer: true,
				min: 0
			},
			"setting.maxFailedLoginAttempts": {
				required: true,
				integer: true,
				min: 1
			},
			"setting.passwordLockTime": {
				required: true,
				digits: true
			},
...
<body>
	...
	<form id="inputForm" action="update" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("Setting.siteImageUrl")}:
				</th>
				<td>
					<input type="text" name="setting.siteImageUrl" class="text" value="${setting.siteImageUrl}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="setting.defaultStoreLogo" class="text" value="${setting.defaultStoreLogo}" maxlength="200" />
						<a href="javascript:;" class="button filePicker">${message("admin.upload.filePicker")}</a>
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="setting.maxFailedLoginAttempts" class="text" value="${setting.maxFailedLoginAttempts}" maxlength="9" title="${message("admin.setting.maxFailedLoginAttemptsTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="setting.passwordLockTime" class="text" value="${setting.passwordLockTime}" maxlength="9" title="${message("admin.setting.passwordLockTimeTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="checkbox" id="smtpSSLEnabled" name="setting.smtpSSLEnabled" value="true"[#if setting.smtpSSLEnabled] checked="checked"[/#if] />
			...
			<tr class="hidden">
				...
				<td>
					<span class="fieldSet">
						<input type="text" id="toMail" name="setting.toMail" class="text ignore" maxlength="200" />
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="setting.automaticReceiveTime" class="text" value="${setting.automaticReceiveTime}" maxlength="9" title="${message("admin.setting.automaticReceiveTimeTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" id="defaultPointScale" name="setting.defaultPointScale" class="text" value="${setting.defaultPointScale}" maxlength="7" title="${message("admin.setting.defaultPointScaleTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="setting.maxPointScale" class="text" value="${setting.maxPointScale}" maxlength="7" />
				</td>
			</tr>
			<tr>
				<th>
