...
<title>${message("admin.product.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.product.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					...
					<li[#if pageable.searchProperty == "name"] class="current"[/#if] val="name">${message("Product.name")}</li>
					<li[#if pageable.searchProperty == "store.name"] class="current"[/#if] val="store.name">${message("Product.store")}</li>
				</ul>
			</div>
		</div>
