...
<title>${message("admin.parameter.edit")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="parameter.orders" class="text" value="${parameter.orders}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
