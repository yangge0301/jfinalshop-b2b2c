...
<title>${message("admin.seo.edit")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="seo.keywords" class="text" value="${seo.keywords}" maxlength="200" title="${message("admin.seo.keywordsTitle")}" />
					<div class="tag">
			...
			<tr>
				...
				<td>
					<input type="text" name="seo.description" class="text" value="${seo.description}" maxlength="200" />
					<div class="tag">
						[#if seo.type == "articleList"]
							<a href="javascript:;" val="[#noparse]${articleCategory.name}[/#noparse]">${message("admin.seo.articleCategoryName")}</a>
						[#elseif seo.type == "articleSearch"]
