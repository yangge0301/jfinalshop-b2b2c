...
<title>${message("admin.seo.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.seo.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
