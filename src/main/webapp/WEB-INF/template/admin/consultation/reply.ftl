...
<title>${message("admin.consultation.reply")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.consultation.reply")}
	</div>
	<form id="inputForm" action="save_reply" method="post">
		...
		<table class="input">
			<tr>
				...
				<td colspan="2">
					<a href="" target="_blank">${consultation.product.name}</a>
				</td>
			</tr>
			<tr>
				<th>
