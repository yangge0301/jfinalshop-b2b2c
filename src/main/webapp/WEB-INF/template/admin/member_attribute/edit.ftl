...
<title>${message("admin.memberAttribute.edit")} - Powered By JFinalShop</title>
...
<body>
	...
	<form id="inputForm" action="update" method="post">
		<input type="hidden" name="memberAttribute.id" value="${memberAttribute.id}" />
		<table class="input">
			<tr>
				<th>
				...
				<td>
					${message("MemberAttribute.Type." + memberAttribute.typeName)}
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="memberAttribute.name" class="text" value="${memberAttribute.name}" maxlength="200" />
				</td>
			</tr>
			[#if memberAttribute.typeName != "select" && memberAttribute.typeName != "checkbox"]
				<tr>
					<th>
						${message("MemberAttribute.pattern")}:
					</th>
					<td>
						<input type="text" id="pattern" name="memberAttribute.pattern" class="text" value="${memberAttribute.pattern}" maxlength="200" />
					</td>
				</tr>
			[/#if]
			<tr>
				...
				<td>
					<input type="text" name="memberAttribute.orders" class="text" value="${memberAttribute.orders}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
			...
			[#if memberAttribute.typeName?? && (memberAttribute.typeName == "select" || memberAttribute.typeName == "checkbox")]
				<tr>
					<th>
						&nbsp;
					</th>
