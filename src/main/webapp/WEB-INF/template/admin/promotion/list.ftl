...
<title>${message("admin.promotion.list")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.promotion.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					...
					<li[#if pageable.searchProperty == "store"] class="current"[/#if] val="store">${message("Promotion.store")}</li>
				</ul>
			</div>
		</div>
