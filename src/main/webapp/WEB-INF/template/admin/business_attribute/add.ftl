...
<title>${message("admin.businessAttribute.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="businessAttribute.name" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" id="pattern" name="businessAttribute.pattern" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="businessAttribute.orders" class="text" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
