...
<title>${message("admin.businessDeposit.log")} - Powered By JFinalShop</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.businessDeposit.log")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="log" method="get">
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if pageable.searchProperty == "business.username"] class="current"[/#if] val="business.username">${message("BusinessDepositLog.business")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			...
			[#list page.list as businessDepositLog]
				<tr>
					<td>
						${message("BusinessDepositLog.Type." + businessDepositLog.typeName)}
					</td>
					<td>
