	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" id="generalRate" name="productCategory.general_rate" class="text" value="${productCategory.generalRate}" maxlength="200"/>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="selfRate" name="productCategory.self_rate" class="text" value="${productCategory.selfRate}" maxlength="200"/>
				</td>
			</tr>
			<tr class="brands">
				<th>
			...
			<tr>
                ...
                <td>
                    <label>
                        <input type="checkbox" name="isMarketable" value="true"[#if productCategory.isMarketable] checked="checked"[/#if] />是否上架
                        <input type="hidden" name="_isMarketable" value="false" />
                    </label>
                    <label>
                        <input type="checkbox" name="isTop" value="true"[#if productCategory.isTop] checked="checked"[/#if] />是否置顶
                        <input type="hidden" name="_isTop" value="false" />
                    </label>
                    <label>
                        <input type="checkbox" name="isCash" value="true"[#if productCategory.isCash] checked="checked"[/#if] />货到付款
            ...
            <tr>
                ...
                <td>
                    <span class="fieldSet">
                        <input type="text" name="productCategory.image" class="text" maxlength="200" value="${productCategory.image}"/>
