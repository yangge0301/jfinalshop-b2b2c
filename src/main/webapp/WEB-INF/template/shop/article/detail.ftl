...
[@seo type = "articleDetail"]
	<title>[#if article.resolveSeoTitle()?has_content]${article.resolveSeoTitle()}[#else]${seo.resolveTitle()}[/#if][#if showPowered] - Powered By JFinalShop[/#if]</title>
			...
			<div class="span10">
				<div class="breadcrumb">
					<ul>
						...
						[@article_category_parent_list article_category_id = articleCategory.id]
