...
<head>
    ...
    <title>${message("shop.order.checkout")}[#if showPowered] - Powered By JFinalShop[/#if]</title>
                ...
                submitHandler: function(form) {
                    $.ajax({
                        ...
                        $(
                            ...
                            <\/span>
                            <span>' + escapeHtml(data.area_name + data.address) + '<\/span>
                ...
                <div id="newReceiver" class="newReceiver[#if currentUser.receivers?has_content] hidden[/#if]">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="consignee" name="receiver.consignee" class="text" maxlength="200" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="address" name="receiver.address" class="text" maxlength="200" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" id="zipCode" name="receiver.zip_code" class="text" maxlength="200" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="text" id="phone" name="receiver.phone" class="text" maxlength="200" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <tr>
                                ...
                                <td>
									...
									[#if orderItem.typeName != "general"]
                                        <span class="red">[${message("Product.Type." + orderItem.typeName)}]</span>
									[/#if]
                                </td>
                                <td>
									[#if orderItem.typeName == "general"]
