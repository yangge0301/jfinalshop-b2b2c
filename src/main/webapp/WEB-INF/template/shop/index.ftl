...
<body>
	...
	<div class="container index">
								...
								<li>
									[@product_category_children_list product_category_id = productCategory.id recursive = false count = 3]
										<div class="item[#if !productCategory_has_next] last[/#if]">
											...
											<div>
												[@brand_list product_category_id = productCategory.id count = 4]
									...
									[@product_category_children_list product_category_id = productCategory.id recursive = false count = 8]
										<div class="menu">
											[#list productCategories as productCategory]
											...
											[/#list]
											<div class="auxiliary">
												[@brand_list product_category_id = productCategory.id count = 8]
													...
													[/#if]
												[/@brand_list]
												[@promotion_list product_category_id = productCategory.id hasEnded = false count = 4]
		...
		[@product_category_root_list count = 3]
			...
			[/@ad_position]
			[#list productCategories as productCategory]
				[@product_list product_category_id = productCategory.id productTagId = 1 count = 10]
					<div class="row">
						<div class="span12">
