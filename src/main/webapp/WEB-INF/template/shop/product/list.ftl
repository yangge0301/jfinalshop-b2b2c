...
[#if productCategory??]
	[@seo type = "productList"]
        <title>[#if productCategory.resolveSeoTitle()?has_content]${productCategory.resolveSeoTitle()}[#else]${seo.resolveTitle()}[/#if][#if showPowered] - Powered By JFinalShop[/#if]</title>
	...
	[/@seo]
[#else]
    <title>${message("shop.product.title")}[#if showPowered] - Powered By JFinalShop[/#if]</title>
    <meta name="author" content="JFinalShop Team" />
    <meta name="copyright" content="JFinalShop" />
[/#if]
			...
			[/#if]
                <div class="bar">
                    <div id="layout" class="layout">
                        ...
                        <span class="page">
								<label>${message("shop.product.totalCount", page.totalRow)} ${page.pageNumber}/[#if page.totalPage > 0]${page.totalPage}[#else]1[/#if]</label>
						[#if page.totalPage > 0]
