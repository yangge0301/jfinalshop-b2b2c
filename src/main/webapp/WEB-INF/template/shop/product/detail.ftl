		...
		[#elseif product.typeName == "exchange"]
            ...
            $exchange.click(function() {
				[@shiro.notAuthenticated]
                    $.redirectLogin("${base}/", "${message("shop.cart.accessDenied")}");
                    return false;
				[/@shiro.notAuthenticated]
...
<div class="container productDetail">
    <div class="row">
        ...
        <div class="span10">
			...
			[#if product.productImagesConverter?has_content]
                <a href="${product.productImagesConverter[0].large}" id="zoom" rel="gallery">
                    <img class="medium" src="${product.productImagesConverter[0].medium}" />
                </a>
			[#else]
            ...
            <div class="sku">
				...
				[#if product.typeName != "general"]
                    <dl>
                        ...
                        <dd>
						${message("Product.Type." + product.typeName)}
                        </dd>
                    </dl>
				[/#if]
			...
			[#if product.typeName == "general" || product.typeName == "exchange"]
                <div class="action">
					[#if product.hasSpecification()]
				...
				[#if product.store.instantMessages?has_content]
                    <div class="instantMessage">
						[#list product.store.instantMessages as instantMessage]
							...
							[#elseif instantMessage.typeName == "aliTalk"]
            ...
            <div id="review" name="review" class="review">
                ...
                <div class="content clearfix">
					[#if product.scoreCount > 0]
						...
						[@review_list product_id = product.id count = 5]
		...
		[#if setting.isConsultationEnabled]
            <div id="consultation" name="consultation" class="consultation">
                ...
                <div class="content">
					[@consultation_list product_id = product.id count = 5]
