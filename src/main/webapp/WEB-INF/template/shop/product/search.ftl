...
$().ready(function() {
	...
	$previousPage.click(function() {
		$pageNumber.val(${pageable.pageNumber});
		$productForm.submit();
		return false;
	});
	
	$nextPage.click(function() {
		$pageNumber.val(${pageable.pageNumber + 1});
		$productForm.submit();
		return false;
	});
		...
		<div class="row">
			...
			<div class="span10">
				...
				<form id="productForm" action="${base}/product/search" method="get">
					...
					<input type="hidden" id="pageNumber" name="pageable.pageNumber" value="${pageable.pageNumber}" />
					...
					<div class="bar">
						<div id="layout" class="layout">
							...
							<a href="javascript:;" class="size[#if pageable.pageSize == 20] current[/#if]" pageSize="20">
								<span>20</span>
							</a>
							<a href="javascript:;" class="size[#if pageable.pageSize == 40] current[/#if]" pageSize="40">
								<span>40</span>
							</a>
							<a href="javascript:;" class="size[#if pageable.pageSize == 80] current[/#if]" pageSize="80">
								<span>80</span>
							</a>
							<span class="page">
								<label>${message("shop.product.totalCount", page.totalRow)} ${pageable.pageNumber}/[#if page.totalPage > 0]${page.totalPage}[#else]1[/#if]</label>
								[#if page.totalPage > 0]
									...
									[/#if]
									[#if pageable.pageNumber != page.totalPage]
									...
									<li>
										...
										<div class="listShop">
											<div class="shopName">
												...
												[#if product.store != null && product.store.typeName == "self"]
