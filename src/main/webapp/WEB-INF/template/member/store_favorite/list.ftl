...
<title>${message("member.storeFavorite.list")}[#if showPowered] - Powered By JFinalShop[/#if]</title>
			...
			<div class="span10">
				<div class="list">
					...
					<table id="listTable" class="list">
						...
						[#list page.list as storeFavorite]
							<tr>
								<td width="110">
								...
								<td>
									${message("Store.Type." + storeFavorite.store.typeName)}
								</td>
								<td width="120">
