...
<title>${message("member.memberDeposit.recharge")}[#if showPowered] - Powered By JFinalShop[/#if]</title>
					...
					<form id="inputForm" action="${base}/payment" method="post" target="_blank">
						...
						<table class="input">
							...
							<tr>
								...
								<td>
									<input type="text" id="rechargeAmount" name="paymentItems[0].amount" class="text" maxlength="16" onpaste="return false;" />
								</td>
							</tr>
							<tr>
								<th>
