...
<title>${message("member.message.list")}[#if showPowered] - Powered By JFinalShop[/#if]</title>
...
<body>
	...
	<div class="container member">
		<div class="row">
			...
			<div class="span10">
				<div class="list">
					<div class="title">${message("member.message.list")} <span>(${message("member.message.total", page.totalRow)})</span></div>
					<table id="listTable" class="list">
						...
						[#list page.list as memberMessage]
							<tr[#if !memberMessage_has_next] class="last"[/#if]>
								...
								<td>
									[#if memberMessage.receiver.id == currentUser.id]
