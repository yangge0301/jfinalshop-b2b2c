...
<title>${message("member.receiver.add")}[#if showPowered] - Powered By JFinalShop[/#if]</title>
					...
					<form id="inputForm" action="save" method="post">
						<table class="input">
							<tr>
								...
								<td>
									<input type="text" name="receiver.consignee" class="text" maxlength="200" />
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="text" name="receiver.address" class="text" maxlength="200" />
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text" name="receiver.zip_code" class="text" maxlength="200" />
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text" name="receiver.phone" class="text" maxlength="200" />
								</td>
							</tr>
							<tr>
								<th>
