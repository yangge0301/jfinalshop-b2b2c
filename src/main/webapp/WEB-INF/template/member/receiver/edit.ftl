...
<title>${message("member.receiver.edit")}[#if showPowered] - Powered By JFinalShop[/#if]</title>
					...
					<form id="inputForm" action="update" method="post">
						...
						<table class="input">
							<tr>
								...
								<td>
									<input type="text" name="receiver.consignee" class="text" value="${receiver.consignee}" maxlength="200" />
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="text" name="receiver.address" class="text" value="${receiver.address}" maxlength="200" />
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text" name="receiver.zip_code" class="text" value="${receiver.zipCode}" maxlength="200" />
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text" name="receiver.phone" class="text" value="${receiver.phone}" maxlength="200" />
								</td>
							</tr>
							<tr>
								<th>
