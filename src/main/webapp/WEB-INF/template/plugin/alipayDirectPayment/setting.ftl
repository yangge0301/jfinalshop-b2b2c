...
<title>${message("admin.plugin.alipayDirectPayment.setting")} - Powered By JFinalShop</title>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					...
					<a href="http://bizpartner.alipay.com/jfinalshop/" target="_blank">[${message("admin.plugin.alipayDirectPayment.register")}]</a>
