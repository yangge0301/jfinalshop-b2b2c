...
<title>${message("admin.plugin.alipayDualPayment.setting")} - Powered By JFinalShop</title>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					...
					<a href="http://bizpartner.alipay.com/jfinalshop/" target="_blank">[${message("admin.plugin.alipayDualPayment.register")}]</a>
