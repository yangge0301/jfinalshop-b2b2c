...
<title>${message("admin.plugin.weixingPublicPayment.setting")} - Powered By SHOP++</title>
...
<body>
	...
	<form id="inputForm" action="update" method="post">
		<table class="input">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>应用ID:
                </th>
                <td>
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>商户应用私钥:
                </th>
                <td>
                    <textarea name="privateKey" class="text">${pluginConfig.getAttribute("privateKey")}</textarea>
                </td>
            </tr>
            <tr>
                <th>
                    <span class="requiredField">*</span>商户应用公钥:
                </th>
                <td>
                    <textarea name="publicKey" class="text">${pluginConfig.getAttribute("publicKey")}</textarea>
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="description" class="text" value="${pluginConfig.getAttribute("description")}" maxlength="200" />
                </td>
            </tr>
            <tr>
                <th>
