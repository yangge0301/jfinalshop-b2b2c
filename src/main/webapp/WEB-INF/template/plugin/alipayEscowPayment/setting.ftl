...
<title>${message("admin.plugin.alipayEscowPayment.setting")} - Powered By JFinalShop</title>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					...
					<a href="http://bizpartner.alipay.com/jfinalshop/" target="_blank">[${message("admin.plugin.alipayEscowPayment.register")}]</a>
