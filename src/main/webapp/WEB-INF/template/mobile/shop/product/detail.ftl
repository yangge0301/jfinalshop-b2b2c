		...
		<%_.each(reviews, function(review, i) {%>
			<li>
				...
				<%if (review.replyReviews != null) {%>
					...
					<%})%>
				<%}%>
				<span class="small gray-darker"><%-moment(review.createdDate).format('YYYY-MM-DD HH:mm:ss')%></span>
			</li>
		<%})%>
	</script>
		...
		<%_.each(consultations, function(consultation, i) {%>
			<li>
				<p>
					...
					<%}%>
					<span class="pull-right small gray-darker"><%-moment(consultation.createdDate).format('YYYY-MM-DD HH:mm:ss')%></span>
				</p>
				<p>
			...
			<div id="tabContentWrapper" class="tab-content-wrapper">
				<div id="tabContent" class="tab-content">
					...
					<div id="summary" class="summary tab-pane active">
						...
						<section>
							<h1>
								[#if product.store.typeName == "self"]
