...
<head>
	...
	<title>${message("business.deliveryTemplate.add")} - Powered By JFinalShop</title>
						...
						<div class="box">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input id="name" name="deliveryTemplate.name" class="form-control" type="text" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required">${message("DeliveryTemplate.content")}:</label>
									<div class="col-xs-10">
										<textarea id="content" name="deliveryTemplate.content"></textarea>
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label">${message("DeliveryTemplate.background")}:</label>
									<div class="col-xs-4">
										<input id="background" name="deliveryTemplate.background" type="hidden" data-provide="fileinput" data-file-type="image" data-show-preview="false">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="width">${message("DeliveryTemplate.width")}:</label>
									<div class="col-xs-4">
										<input id="width" name="deliveryTemplate.width" class="form-control" type="text" value="1000" maxlength="9">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="height">${message("DeliveryTemplate.height")}:</label>
									<div class="col-xs-4">
										<input id="height" name="deliveryTemplate.height" class="form-control" type="text" value="400" maxlength="9">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="offsetX">${message("DeliveryTemplate.offsetX")}:</label>
									<div class="col-xs-4">
										<input id="offsetX" name="deliveryTemplate.offset_x" class="form-control" type="text" value="0" maxlength="9">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="offsetY">${message("DeliveryTemplate.offsetY")}:</label>
									<div class="col-xs-4">
										<input id="offsetY" name="deliveryTemplate.offset_y" class="form-control" type="text" value="0" maxlength="9">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-xs-10 checkbox">
										<input id="isDefault" name="deliveryTemplate.is_default" type="text" value="false" data-toggle="checkbox-x">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="memo">${message("DeliveryTemplate.memo")}:</label>
									<div class="col-xs-4">
										<input id="memo" name="deliveryTemplate.memo" class="form-control" type="text" maxlength="200">
									</div>
								</div>
							</div>
