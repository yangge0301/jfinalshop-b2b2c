...
<head>
	...
	<title>${message("business.areaFreightConfig.add")} - Powered By JFinalShop</title>
					...
					<div class="box">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-xs-4">
									<input id="firstWeight" name="areaFreightConfig.first_weight" class="form-control" type="text" maxlength="9">
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label item-required" for="continueWeight">${message("FreightConfig.continueWeight")}:</label>
								<div class="col-xs-4">
									<input id="continueWeight" name="areaFreightConfig.continue_weight" class="form-control" type="text" maxlength="9">
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label item-required" for="firstPrice">${message("FreightConfig.firstPrice")}:</label>
								<div class="col-xs-4">
									<input id="firstPrice" name="areaFreightConfig.first_price" class="form-control" type="text" maxlength="16">
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label item-required" for="continue_price">${message("FreightConfig.continuePrice")}:</label>
								<div class="col-xs-4">
									<input id="continuePrice" name="areaFreightConfig.continue_price" class="form-control" type="text" maxlength="16">
								</div>
							</div>
						</div>
