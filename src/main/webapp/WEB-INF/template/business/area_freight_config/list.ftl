...
<head>
	...
	<title>${message("business.areaFreightConfig.list")} - Powered By JFinalShop</title>
					...
					<div class="box">
									...
									<div class="box-tools">
										<div id="search" class="input-group">
											<div class="input-group-btn">
												...
												<ul class="dropdown-menu">
													<li[#if !pageable.searchProperty?? || pageable.searchProperty == "area.fullName"] class="active"[/#if] data-search-property="area.fullName">
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover">
								...
								<tbody>
									[#list page.list as areaFreightConfig]
										<tr>
											<td>
