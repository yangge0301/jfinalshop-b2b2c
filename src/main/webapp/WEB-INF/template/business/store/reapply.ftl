...
<head>
	...
	<title>${message("business.store.reapply")} - Powered By JFinalShop</title>
...
<body class="hold-transition sidebar-mini">
	<div class="container-fluid">
		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<form id="storeForm" class="form-horizontal" action="${base}/business/store/save_reapply" method="post">
