...
<head>
	...
	<title>${message("business.store.setting")} - Powered By JFinalShop</title>
...
<body class="hold-transition sidebar-mini">
	<div class="container-fluid">
		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<form id="storeForm" class="form-horizontal" action="${base}/business/store/save_setting" method="post">
						<div class="box">
							<div class="box-body">
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="name">${message("Store.name")}:</label>
									<div class="col-xs-4">
										<input id="name" name="store.name" class="form-control" type="text" value="${currentStore.name}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input name="store.logo" type="hidden" value="${currentStore.logo}" data-provide="fileinput" data-file-type="image">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="email">${message("Store.email")}:</label>
									<div class="col-xs-4">
										<input id="email" name="store.email" class="form-control" type="text" value="${currentStore.email}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="mobile">${message("Store.mobile")}:</label>
									<div class="col-xs-4">
										<input id="mobile" name="store.mobile" class="form-control" type="text" value="${currentStore.mobile}" maxlength="16">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="phone">${message("Store.phone")}:</label>
									<div class="col-xs-4">
										<input id="phone" name="store.phone" class="form-control" type="text" value="${currentStore.phone}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="address">${message("Store.address")}:</label>
									<div class="col-xs-4">
										<input id="address" name="store.address" class="form-control" type="text" value="${currentStore.address}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="zipCode">${message("Store.zipCode")}:</label>
									<div class="col-xs-4">
										<input id="zipCode" name="store.zip_code" class="form-control" type="text" value="${currentStore.zipCode}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="introduction">${message("Store.introduction")}:</label>
									<div class="col-xs-4">
										<textarea id="introduction" name="store.introduction" class="form-control" maxlength="200">${currentStore.introduction}</textarea>
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="keyword">${message("Store.keyword")}:</label>
									<div class="col-xs-4">
										<input id="keyword" name="store.keyword" class="form-control" type="text" value="${currentStore.keyword}" maxlength="200" title="${message("business.store.keywordTitle")}">
									</div>
								</div>
