...
<head>
	...
	<title>${message("business.store.register")} - Powered By JFinalShop</title>
...
<body class="hold-transition sidebar-mini">
	<div class="container-fluid">
		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<form id="storeForm" class="form-horizontal" action="${base}/business/store/save_register" method="post">
								...
								<div class="tab-content">
									<div id="info" class="tab-pane active">
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="name" name="store.name" class="form-control" type="text" maxlength="200">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="mobile" name="store.mobile" class="form-control" type="text" maxlength="16">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label item-required" for="email">${message("Store.email")}:</label>
											<div class="col-xs-4">
												<input id="email" name="store.email" class="form-control" type="text" maxlength="200">
											</div>
										</div>
									</div>
