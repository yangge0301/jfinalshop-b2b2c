...
<head>
	...
	<title>${message("business.storeProductCategory.add")} - Powered By JFinalShop</title>
						...
						<div class="box">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input id="name" name="storeProductCategory.name" class="form-control" type="text" maxlength="200">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input id="order" name="storeProductCategory.orders" class="form-control" type="text" maxlength="9">
									</div>
								</div>
							</div>
