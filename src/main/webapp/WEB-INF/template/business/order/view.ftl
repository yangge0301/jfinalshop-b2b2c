...
<head>
	...
	<title>${message("business.order.view")} - Powered By JFinalShop</title>
													...
													<div class="row">
														...
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="bank" name="orderPayment.bank" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="account" name="orderPayment.account" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="amount" name="orderPayment.amount" class="form-control" type="text"[#if order.amountPayable > 0] value="${order.amountPayable}"[/#if] maxlength="16">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="payer" name="orderPayment.payer" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
														...
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="memo" name="orderPayment.memo" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="bank" name="orderRefunds.bank" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="account" name="orderRefunds.account" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="amount" name="orderRefunds.amount" class="form-control" type="text" value="${order.refundableAmount}" maxlength="16">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="payee" name="orderRefunds.payee" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
														...
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="memo" name="orderRefunds.memo" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
													</div>
													...
													<div id="shippingLogistics" class="row">
														...
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="trackingNo" name="orderShipping.tracking_no" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="freight" name="orderShipping.freight" class="form-control" type="text" maxlength="16">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="consignee" name="orderShipping.consignee" class="form-control" type="text" value="[#noautoesc]${order.consignee?html?js_string}[/#noautoesc]" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="zipCode" name="orderShipping.zip_code" class="form-control" type="text" value="[#noautoesc]${order.zipCode?html?js_string}[/#noautoesc]" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
														...
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="address" name="orderShipping.address" class="form-control" type="text" value="[#noautoesc]${order.address?html?js_string}[/#noautoesc]" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="phone" name="orderShipping.phone" class="form-control" type="text" value="[#noautoesc]${order.phone?html?js_string}[/#noautoesc]" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="memo" name="orderShipping.memo" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
													</div>
																	...
																	[#noautoesc]
																		<td>
																			...
																			[#if orderItem.specificationsConverter?has_content]
																				<span class="gray-darker">[${orderItem.specificationsConverter?join(", ")?html?js_string}]</span>
																			[/#if]
																			[#if orderItem.typeName != "general"]
																				<span class="text-red">[${message("Product.Type." + orderItem.typeName)}]</span>
																			[/#if]
																		</td>
																	[/#noautoesc]
													...
													<div class="row">
														...
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="trackingNo" name="orderReturns.tracking_no" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="freight" name="orderReturns.freight" class="form-control" type="text" maxlength="16">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="shipper" name="orderReturns.shipper" class="form-control" type="text" value="[#noautoesc]${order.consignee?html?js_string}[/#noautoesc]" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="zipCode" name="orderReturns.zip_code" class="form-control" type="text" value="[#noautoesc]${order.zipCode?html?js_string}[/#noautoesc]" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
														...
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="address" name="orderReturns.address" class="form-control" type="text" value="[#noautoesc]${order.address?html?js_string}[/#noautoesc]" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="phone" name="orderReturns.phone" class="form-control" type="text" value="[#noautoesc]${order.phone?html?js_string}[/#noautoesc]" maxlength="200">
																</div>
															</div>
														</div>
														<div class="col-xs-6">
															<div class="form-group">
																...
																<div class="col-xs-8">
																	<input id="memo" name="orderReturns.memo" class="form-control" type="text" maxlength="200">
																</div>
															</div>
														</div>
													</div>
									...
									<div id="orderInfo" class="tab-pane active">
										<div class="row">
											<div class="col-xs-6 col-xs-offset-2">
												<div class="form-group">
													<button id="reviewModalButton" class="btn btn-default" type="button" data-toggle="modal" data-target="#reviewModal"[#if order.hasExpired() || order.statusName != "pendingReview"] disabled[/#if]>${message("business.order.review")}</button>
													[#if currentStore.isSelf()]
													...
													<button id="completeModalButton" class="btn btn-default" type="button" data-toggle="modal" data-target="#completeModal"[#if order.hasExpired() || order.statusName != "received"] disabled[/#if]>${message("business.order.complete")}</button>
													<button id="failModalButton" class="btn btn-default" type="button" data-toggle="modal" data-target="#failModal"[#if order.hasExpired() || (order.statusName != "pendingShipment" && order.statusName != "shipped" && order.statusName != "received")] disabled[/#if]>${message("business.order.fail")}</button>
												</div>
											</div>
											<div class="col-xs-6">
												<dl class="items dl-horizontal">
													...
													<dd>${message("Order.Type." + order.typeName)}</dd>
													...
													<dd>
														[#if order.promotionNamesConverter?has_content]
															<span>${order.promotionNamesConverter?join(", ")}</span>
														[#else]
															-
														[/#if]
													</dd>
												...
												[#list order.orderItems as orderItem]
													<tr>
														...
														<td>
															...
															[/#if]
															[#if orderItem.specificationsConverter?has_content]
																<span class="gray-darker">[${orderItem.specificationsConverter?join(", ")}]</span>
															[/#if]
															[#if orderItem.type != "general"]
																<span class="text-red">[${message("Product.Type." + orderItem.typeName)}]</span>
															[/#if]
											...
											<tbody>
												[#list order.orderPayments as orderPayment]
													<tr>
														...
														<td>${message("OrderPayment.Method." + orderPayment.methodName)}</td>
											...
											<tbody>
												[#list order.orderRefunds as orderRefunds]
													<tr>
														...
														<td>${message("OrderRefunds.Method." + orderRefunds.methodName)}</td>
										...
										<table class="table table-hover">
											...
											<tbody>
												[#list order.orderLogs as orderLog]
													<tr>
														<td>${message("OrderLog.Type." + orderLog.typeName)}</td>
														<td>
															[#if orderLog.detail??]
