...
<head>
	...
	<title>${message("business.stock.stockIn")} - Powered By JFinalShop</title>
...
<body class="hold-transition sidebar-mini">
	<div class="container-fluid">
		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<form id="stockForm" class="form-horizontal" action="${base}/business/stock/save_stock_in" method="post">
						<div class="box">
							<div class="box-body">
