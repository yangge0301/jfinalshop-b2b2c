...
<head>
	...
	<title>${message("business.stock.log")} - Powered By JFinalShop</title>
...
<body class="hold-transition">
	<div class="container-fluid">
		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<form action="${base}/business/stock/log" method="post">
										...
										<div class="box-tools">
											<div id="search" class="input-group">
												<div class="input-group-btn">
													...
													<ul class="dropdown-menu">
														<li[#if !pageable.searchProperty?? || pageable.searchProperty == "sku.sn"] class="active"[/#if] data-search-property="sku.sn">
															<a href="javascript:;">${message("Sku.sn")}</a>
														</li>
														<li[#if pageable.searchProperty == "product.name"] class="active"[/#if] data-search-property="product.name">
								...
								<table class="table table-hover">
									<thead>
										<tr>
											...
											<th>
												<a href="javascript:;" data-order-property="product.name">
									...
									<tbody>
										[#list page.list as stockLog]
											<tr>
												...
												<td>
													<span title="${stockLog.sku.product.name}">${abbreviate(stockLog.sku.product.name, 50, "...")}</span>
													[#if stockLog.sku.specifications?has_content]
														<span class="gray-darker">[${stockLog.sku.specifications?join(", ")}]</span>
													[/#if]
												</td>
												<td>${message("StockLog.Type." + stockLog.typeName)}</td>
