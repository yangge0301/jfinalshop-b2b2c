...
<head>
	...
	<title>${message("business.deliveryCenter.list")} - Powered By JFinalShop</title>
											...
											<div id="search" class="input-group">
												<div class="input-group-btn">
													...
													<ul class="dropdown-menu">
														...
														<li[#if pageable.searchProperty == "contact"] class="active"[/#if] data-search-property="contact">
														...
														<li[#if pageable.searchProperty == "mobile"] class="active"[/#if] data-search-property="mobile">
