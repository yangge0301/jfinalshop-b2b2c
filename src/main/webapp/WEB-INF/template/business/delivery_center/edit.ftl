...
<head>
	...
	<title>${message("business.deliveryCenter.edit")} - Powered By JFinalShop</title>
			...
			<div class="row">
				<div class="col-xs-12">
					<form id="deliveryCenterForm" class="form-horizontal" action="${base}/business/delivery_center/update" method="post">
						<input name="deliveryCenter.id" type="hidden" value="${deliveryCenter.id}">
						<div class="box">
							<div class="box-body">
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="name">${message("DeliveryCenter.name")}:</label>
									<div class="col-xs-4">
										<input id="name" name="deliveryCenter.name" class="form-control" type="text" value="${deliveryCenter.name}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="contact">${message("DeliveryCenter.contact")}:</label>
									<div class="col-xs-4">
										<input id="contact" name="deliveryCenter.contact" class="form-control" type="text" value="${deliveryCenter.contact}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input id="address" name="deliveryCenter.address" class="form-control" type="text" value="${deliveryCenter.address}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="zipCode">${message("DeliveryCenter.zipCode")}:</label>
									<div class="col-xs-4">
										<input id="zipCode" name="deliveryCenter.zip_code" class="form-control" type="text" value="${deliveryCenter.zipCode}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="phone">${message("DeliveryCenter.phone")}:</label>
									<div class="col-xs-4">
										<input id="phone" name="deliveryCenter.phone" class="form-control" type="text" value="${deliveryCenter.phone}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="mobile">${message("DeliveryCenter.mobile")}:</label>
									<div class="col-xs-4">
										<input id="mobile" name="deliveryCenter.mobile" class="form-control" type="text" value="${deliveryCenter.mobile}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label for="isDefault" class="col-xs-2 control-label">${message("DeliveryCenter.isDefault")}:</label>
									<div class="col-xs-10 checkbox">
										<input id="isDefault" name="deliveryCenter.is_default" type="text" value="${deliveryCenter.isDefault?string("true", "false")}" data-toggle="checkbox-x">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="memo">${message("DeliveryCenter.memo")}:</label>
									<div class="col-xs-4">
										<input id="memo" name="deliveryCenter.memo" class="form-control" type="text" value="${deliveryCenter.memo}" maxlength="200">
									</div>
								</div>
							</div>
