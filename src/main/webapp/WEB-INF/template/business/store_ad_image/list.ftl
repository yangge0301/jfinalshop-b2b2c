...
<head>
	...
	<title>${message("business.storeAdImage.list")} - Powered By JFinalShop</title>
						...
						<div class="box">
										...
										<div class="box-tools">
											<div id="search" class="input-group">
												<div class="input-group-btn">
													...
													<ul class="dropdown-menu">
														<li[#if !pageable.searchProperty?? || pageable.searchProperty == "title"] class="active"[/#if] data-search-property="title">
															<a href="javascript:;">${message("StoreAdImage.title")}</a>
														</li>
														<li[#if pageable.searchProperty == "url"] class="active"[/#if] data-search-property="url">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover">
									...
									<tbody>
										[#list page.list as storeAdImage]
											<tr>
												<td>
