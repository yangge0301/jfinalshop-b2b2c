...
<head>
	...
	<title>${message("business.storeAdImage.add")} - Powered By JFinalShop</title>
						...
						<div class="box">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input id="title" name="storeAdImage.title" class="form-control" type="text" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="url">${message("StoreAdImage.url")}:</label>
									<div class="col-xs-4">
										<input id="url" name="storeAdImage.url" class="form-control" type="text" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required">${message("StoreAdImage.image")}:</label>
									<div class="col-xs-4">
										<input name="storeAdImage.image" type="hidden" data-provide="fileinput" data-file-type="image">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="order">${message("business.common.order")}:</label>
									<div class="col-xs-4">
										<input id="order" name="storeAdImage.orders" class="form-control" type="text" maxlength="9">
									</div>
								</div>
							</div>
