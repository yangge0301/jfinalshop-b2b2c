		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					[#elseif currentStore.statusName == "pending"]
						${message("business.index.storePending")}
					[#elseif currentStore.statusName == "failed"]
						${message("business.index.storeFailed")}
					[#elseif currentStore.statusName == "approved"]
		...
		<div class="content-wrapper" style="margin-left: 0px;">
			<div class="container-fluid">
				...
				<section class="content">
					[#if currentStore?? && currentStore.statusName == "success"]
