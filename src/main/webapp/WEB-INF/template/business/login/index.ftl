...
<head>
    ...
    <title>${message("business.login.title")} - Powered By JFinalShop</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">欢迎登录商家中心</p>

        <form action="${base}/business/login" method="post" id="login-form">
            <div class="form-group has-feedback">
                <input type="text" class="form-control"  name="username" placeholder="${message("business.login.usernameTitle")}">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" name="password" placeholder="${message("business.login.password")}">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
            	<div class="input-group">
                	<input type="text" class="form-control"  id="captcha" name="captcha" placeholder="${message("common.captcha.name")}" style="width: 60%">
                </div>
            </div>
            <div class="row">
                <div class="col-xs-6">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox" name="rememberMe"> ${message("business.login.isRememberUsername")}
                        </label>
                    </div>
                </div>
                 <!-- /.col -->
                <div class="col-xs-6">
                    <div class="checkbox pull-right">
                        <a href="${base}/password/forgot?type=business">${message("business.login.forgotPassword")}</a>
                        <span>&nbsp;/&nbsp;</span>
                        <a href="${base}/business/register" class="text-center">${message("business.login.register")}</a>
                    </div>
                </div>
                <!-- /.col -->
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-danger btn-block btn-flat">${message("business.login.submit")}</button>
                </div>
            </div>
        </form>
