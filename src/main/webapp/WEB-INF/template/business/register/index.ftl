...
<head>
	...
	<title>${message("business.register.title")} - Powered By JFinalShop</title>
		...
		$registerForm.validate({
			...
			submitHandler: function(form) {
				$.ajax({
					...
					success: function() {
						setTimeout(function() {
							location.href = "${base}/business/login";
						}, 3000);
					},
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-xs-5">
										<input id="username" name="business.username" class="form-control" type="text" maxlength="20">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-3 control-label item-required" for="password">${message("business.register.password")}:</label>
									<div class="col-xs-5">
										<input id="password" name="business.password" class="form-control" type="password" maxlength="20" autocomplete="off">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-xs-5">
										<input id="email" name="business.email" class="form-control" type="text" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-3 control-label" for="mobile">${message("business.register.mobile")}:</label>
									<div class="col-xs-5">
										<input id="mobile" name="business.mobile" class="form-control" type="text" maxlength="200">
									</div>
								</div>
								[@business_attribute_list]
									[#list businessAttributes as businessAttribute]
										<div class="form-group">
											...
											[#elseif businessAttribute.typeName == "licenseImage" || businessAttribute.typeName == "idCardImage" || businessAttribute.typeName == "organizationImage" || businessAttribute.typeName == "taxImage" || businessAttribute.typeName == "image"]
												<div class="col-xs-5">
