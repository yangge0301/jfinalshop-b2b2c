...
<head>
	...
	<title>${message("business.instantMessage.list")} - Powered By JFinalShop</title>
						...
						<div class="box">
											...
											<div id="search" class="input-group">
												<div class="input-group-btn">
													...
													<ul class="dropdown-menu">
														...
														<li[#if pageable.searchProperty == "account"] class="active"[/#if] data-search-property="account">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover">
									...
									<tbody>
										[#list page.list as instantMessage]
											<tr>
												<td>
													<input name="ids" type="checkbox" value="${instantMessage.id}">
												</td>
												<td>${instantMessage.name}</td>
												<td>${message("InstantMessage.Type." + instantMessage.typeName)}</td>
												<td>${instantMessage.account}</td>
												<td>${instantMessage.orders}</td>
												<td>
