...
<head>
	...
	<title>${message("business.instantMessage.add")} - Powered By JFinalShop</title>
						...
						<div class="box">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input id="name" name="instantMessage.name" class="form-control" type="text" maxlength="200">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input id="account" name="instantMessage.account" class="form-control" type="text" maxlength="10">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="order">${message("business.common.order")}:</label>
									<div class="col-xs-4">
										<input id="order" name="instantMessage.orders" class="form-control" type="text" maxlength="9">
									</div>
								</div>
							</div>
