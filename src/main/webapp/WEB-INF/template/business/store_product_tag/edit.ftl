...
<head>
	...
	<title>${message("business.storeProductTag.edit")} - Powered By JFinalShop</title>
			...
			<div class="row">
				<div class="col-xs-12">
					<form id="storeProductTagForm" class="form-horizontal" action="${base}/business/store_product_tag/update" method="post">
						<input name="storeProductTag.id" type="hidden" value="${storeProductTag.id}">
						<div class="box">
							<div class="box-body">
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="name">${message("StoreProductTag.name")}:</label>
									<div class="col-xs-4">
										<input id="name" name="storeProductTag.name" class="form-control" type="text" value="${storeProductTag.name}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label">${message("StoreProductTag.icon")}:</label>
									<div class="col-xs-4">
										<input name="storeProductTag.icon" type="hidden" value="${storeProductTag.icon}" data-provide="fileinput" data-file-type="image">
									</div>
								</div>
								<div class="form-group">
									<label for="isEnabled" class="col-xs-2 control-label">${message("StoreProductTag.isEnabled")}:</label>
									<div class="col-xs-10 checkbox">
										<input id="isEnabled" name="storeProductTag.is_enabled" type="text" value="${storeProductTag.isEnabled?string("true", "false")}" data-toggle="checkbox-x">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="memo">${message("StoreProductTag.memo")}:</label>
									<div class="col-xs-4">
										<input id="memo" name="storeProductTag.memo" class="form-control" type="text" value="${storeProductTag.memo}" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label" for="order">${message("business.common.order")}:</label>
									<div class="col-xs-4">
										<input id="order" name="storeProductTag.orders" class="form-control" type="text" value="${storeProductTag.orders}" maxlength="9">
									</div>
								</div>
							</div>
