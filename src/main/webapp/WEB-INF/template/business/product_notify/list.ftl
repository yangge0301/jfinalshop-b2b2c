...
<head>
	...
	<title>${message("business.productNotify.list")} - Powered By JFinalShop</title>
						...
						<div class="box">
										...
										<div class="box-tools">
											<div id="search" class="input-group">
												<div class="input-group-btn">
													...
													<ul class="dropdown-menu">
														<li[#if !pageable.searchProperty?? || pageable.searchProperty == "email"] class="active"[/#if] data-search-property="email">
															<a href="javascript:;">${message("ProductNotify.email")}</a>
														</li>
														<li[#if pageable.searchProperty == "sku.product.name"] class="active"[/#if] data-search-property="sku.product.name">
															<a href="javascript:;">${message("business.productNotify.sku")}</a>
														</li>
														<li[#if pageable.searchProperty == "member.username"] class="active"[/#if] data-search-property="member.username">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover">
									...
									<tbody>
										[#list page.list as productNotify]
											<tr>
												<td>
