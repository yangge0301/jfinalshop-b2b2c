...
<head>
	...
	<title>${message("business.coupon.edit")} - Powered By JFinalShop</title>
								...
								<div class="tab-content">
									<div id="base" class="tab-pane active">
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="name" name="coupon.name" class="form-control" type="text" value="${coupon.name}" maxlength="200">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label item-required" for="prefix">${message("Coupon.prefix")}:</label>
											<div class="col-xs-4">
												<input id="prefix" name="coupon.prefix" class="form-control" type="text" value="${coupon.prefix}" maxlength="200">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="input-group" data-provide="datetimerangepicker" data-date-format="YYYY-MM-DD HH:mm:ss">
													<input id="beginDate" name="coupon.begin_date" class="form-control" type="text" value="[#if coupon.beginDate??]${coupon.beginDate?string("yyyy-MM-dd HH:mm:ss")}[/#if]">
													<div class="input-group-addon">-</div>
													<input name="coupon.end_date" class="form-control" type="text" value="[#if coupon.endDate??]${coupon.endDate?string("yyyy-MM-dd HH:mm:ss")}[/#if]">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="input-group">
													<input id="minimumPrice" name="coupon.minimum_price" class="form-control" type="text" value="${coupon.minimumPrice}" maxlength="16">
													<div class="input-group-addon">-</div>
													<input name="coupon.maximum_price" class="form-control" type="text" value="${coupon.maximumPrice}" maxlength="16">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="input-group">
													<input id="minimumQuantity" name="coupon.minimum_quantity" class="form-control" type="text" value="${coupon.minimumQuantity}" maxlength="9">
													<div class="input-group-addon">-</div>
													<input name="coupon.maximum_quantity" class="form-control" type="text" value="${coupon.maximumQuantity}" maxlength="9">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="priceExpression" name="coupon.price_expression" class="form-control" type="text" value="${coupon.priceExpression}" maxlength="200" title="${message("business.coupon.priceExpressionTitle")}">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label">${message("business.common.setting")}:</label>
											<div class="col-xs-10 checkbox">
												<input id="isEnabled" name="coupon.is_enabled" type="text" value="${coupon.isEnabled?string("true", "false")}" data-toggle="checkbox-x">
												<label for="isEnabled" class="cbx-label">${message("Coupon.isEnabled")}</label>
												<input id="isExchange" name="coupon.is_exchange" type="text" value="${coupon.isExchange?string("true", "false")}" data-toggle="checkbox-x">
										...
										<div class="form-group[#if !coupon.isExchange] hidden-element[/#if]">
											...
											<div class="col-xs-4">
												<input id="point" name="coupon.point" class="form-control" type="text" value="${coupon.point}" maxlength="9"[#if !coupon.isExchange] disabled[/#if]>
											</div>
										</div>
									</div>
									<div id="introduction" class="tab-pane">
										<textarea name="coupon.introduction" data-provide="editor">${coupon.introduction}</textarea>
									</div>
								</div>
							</div>
