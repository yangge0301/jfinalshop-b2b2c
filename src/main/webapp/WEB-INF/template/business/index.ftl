...
<div class="wrapper">
  ...
  <div class="content-wrapper" id="mainDiv">
    <iframe src="/business/index/main" frameborder="0" scrolling="auto" id="iframe" name="iframe"  onload="setIframeHeight(this)" height=100% width=100%></iframe>
  </div>
  <!-- /.content-wrapper -->
...
<!-- 加载菜单 -->
<script>
   ajaxPost(base + "/business/menu/findAll", null, function(data) {
	  var $li, $menu_f_ul;
