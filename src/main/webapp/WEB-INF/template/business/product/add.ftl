...
<head>
	...
	<title>${message("business.product.add")} - Powered By JFinalShop</title>
				...
				<div class="row">
					<div class="col-xs-12">
						<form id="productForm" class="form-horizontal" action="${base}/business/product/save" method="post">
							<input id="isDefault" name="sku.is_default" type="hidden" value="true">
							<div class="box">
								<div class="box-body">
									...
									<div class="tab-content">
										<div id="base" class="tab-pane active">
											...
											<div class="form-group">
												...
												<div class="col-xs-4">
													<input id="sn" name="product.sn" class="form-control" type="text" maxlength="100" title="${message("business.product.snTitle")}">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-2 control-label item-required" for="name">${message("Product.name")}:</label>
												<div class="col-xs-4">
													<input id="name" name="product.name" class="form-control" type="text" maxlength="200">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-2 control-label" for="caption">${message("Product.caption")}:</label>
												<div class="col-xs-4">
													<input id="caption" name="product.caption" class="form-control" type="text" maxlength="200">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-xs-4">
													<input id="marketPrice" name="sku.market_price" class="form-control" type="text" maxlength="16" title="${message("business.product.marketPriceTitle")}">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-2 control-label">${message("Product.image")}:</label>
												<div class="col-xs-4">
													<input name="product.image" type="hidden" data-provide="fileinput" data-file-type="image">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-2 control-label" for="unit">${message("Product.unit")}:</label>
												<div class="col-xs-4">
													<input id="unit" name="product.unit" class="form-control" type="text" maxlength="200">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-2 control-label" for="weight">${message("Product.weight")}:</label>
												<div class="col-xs-4">
													<input id="weight" name="product.weight" class="form-control" type="text" maxlength="9" title="${message("business.product.weightTitle")}">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-2 control-label" for="rewardPoint">${message("Sku.rewardPoint")}:</label>
												<div class="col-xs-4">
													<input id="rewardPoint" name="sku.reward_point" class="form-control" type="text" maxlength="9" title="${message("business.product.rewardPointTitle")}">
												</div>
											</div>
											<div class="hidden-element form-group">
												...
												<div class="col-xs-4">
													<input id="exchangePoint" name="sku.exchange_point" class="form-control" type="text" maxlength="9" disabled>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-xs-10 checkbox">
													<input id="isMarketable" name="product.is_marketable" type="text" value="true" data-toggle="checkbox-x">
													<label for="isMarketable" class="cbx-label">${message("Product.isMarketable")}</label>
													<input id="isList" name="product.is_list" type="text" value="true" data-toggle="checkbox-x">
													<label for="isList" class="cbx-label">${message("Product.isList")}</label>
													<input id="isTop" name="product.is_top" type="text" value="false" data-toggle="checkbox-x">
													<label for="isTop" class="cbx-label">${message("Product.isTop")}</label>
													<input id="isDelivery" name="product.is_delivery" type="text" value="true" data-toggle="checkbox-x">
											...
											<div class="form-group">
												...
												<div class="col-xs-4">
													<input id="memo" name="product.memo" class="form-control" type="text" maxlength="200">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-2 control-label" for="keyword">${message("Product.keyword")}:</label>
												<div class="col-xs-4">
													<input id="keyword" name="product.keyword" class="form-control" type="text" maxlength="200" title="${message("business.product.keywordTitle")}">
												</div>
											</div>
										</div>
										<div id="introduction" class="tab-pane">
											<textarea name="product.introduction" data-provide="editor"></textarea>
										</div>
