...
<head>
	...
	<title>${message("business.businessDeposit.recharge")} - Powered By JFinalShop</title>
						...
						<div class="box">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-xs-2">
										<input id="rechargeAmount" name="paymentItems[0].amount" class="form-control" type="text" maxlength="16">
									</div>
								</div>
