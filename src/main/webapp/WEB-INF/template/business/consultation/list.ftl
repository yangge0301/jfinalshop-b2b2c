...
<head>
	...
	<title>${message("business.consultation.list")} - Powered By JFinalShop</title>
						...
						<div class="box">
										...
										<div class="box-tools">
											<div id="search" class="input-group">
												<div class="input-group-btn">
													...
													<ul class="dropdown-menu">
														<li[#if !pageable.searchProperty?? || pageable.searchProperty == "content"] class="active"[/#if] data-search-property="content">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover">
									...
									<tbody>
										[#list page.list as consultation]
											<tr>
												<td>
