...
<head>
	...
	<title>${message("business.consultation.reply")} - Powered By JFinalShop</title>
	...
	<div class="container-fluid">
		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<form id="consultationForm" class="form-horizontal" action="${base}/business/consultation/save_reply" method="post">
