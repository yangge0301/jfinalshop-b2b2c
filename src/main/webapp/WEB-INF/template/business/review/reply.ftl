...
<head>
	...
	<title>${message("business.review.reply")} - Powered By JFinalShop</title>
...
<body class="hold-transition sidebar-mini">
	<div class="container-fluid">
		...
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<form id="reviewForm" class="form-horizontal" action="${base}/business/review/save_reply" method="post">
