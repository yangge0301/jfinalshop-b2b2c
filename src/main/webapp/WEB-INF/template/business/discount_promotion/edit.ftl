...
<head>
	...
	<title>${message("business.discountPromotion.edit")} - Powered By JFinalShop</title>
								...
								<div class="tab-content">
									<div id="base" class="tab-pane active">
										...
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="discount" name="promotion.discount" class="form-control" type="text" value="${promotion.discount}" maxlength="9" title="${message("business.fullReductionPromotion.discountNote")}">
											</div>
										</div>
										<div class="form-group">
									...
									<div id="introduction" class="tab-pane">
										<textarea name="promotion.introduction" data-provide="editor">${promotion.introduction}</textarea>
									</div>
								</div>
							</div>
