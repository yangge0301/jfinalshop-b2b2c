...
<head>
	...
	<title>${message("business.discountPromotion.add")} - Powered By JFinalShop</title>
								...
								<div class="tab-content">
									<div id="base" class="tab-pane active">
										...
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="input-group">
													<input id="minimumPrice" name="promotion.minimum_price" class="form-control" type="text" maxlength="16">
													<div class="input-group-addon">-</div>
										...
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="discount" name="promotion.discount" class="form-control" type="text" maxlength="9" title="${message("business.fullReductionPromotion.discountNote")}">
											</div>
										</div>
										<div class="form-group">
