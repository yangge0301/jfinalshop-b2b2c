...
<head>
	...
	<title>${message("business.cash.application")} - Powered By JFinalShop</title>
						...
						<div class="box">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input id="amount" name="cash.amount" class="form-control" type="text" maxlength="16">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="bank">${message("Cash.bank")}:</label>
									<div class="col-xs-4">
										<input id="bank" name="cash.bank" class="form-control" type="text" maxlength="200">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-2 control-label item-required" for="account">${message("Cash.account")}:</label>
									<div class="col-xs-4">
										<input id="account" name="cash.account" class="form-control" type="text" maxlength="200">
									</div>
								</div>
							</div>
