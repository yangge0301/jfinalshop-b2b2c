...
<head>
	...
	<title>${message("business.fullReductionPromotion.add")} - Powered By JFinalShop</title>
	...
	$().ready(function() {
		...
		$fullReductionPromotionForm.validate({
			rules: {
				...
				"promotion.conditions_number": {
					required: true,
					digits: true
				},
				"promotion.credit_number": {
					required: true,
					digits: true,
								...
								<div class="tab-content">
									<div id="base" class="tab-pane active">
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="name" name="promotion.name" class="form-control" type="text" maxlength="200">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label item-required" for="title">${message("Promotion.title")}:</label>
											<div class="col-xs-4">
												<input id="title" name="promotion.title" class="form-control" type="text" maxlength="200">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label">${message("Promotion.image")}:</label>
											<div class="col-xs-4">
												<input name="promotion.image" type="hidden" data-provide="fileinput" data-file-type="image">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="input-group" data-provide="datetimerangepicker" data-date-format="YYYY-MM-DD HH:mm:ss">
													<input id="beginDate" name="promotion.begin_date" class="form-control" type="text">
													<div class="input-group-addon">-</div>
													<input name="promotion.end_date" class="form-control" type="text">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="input-group">
													...
													<div class="input-group-addon">-</div>
													<input name="promotion.maximum_price" class="form-control" type="text" maxlength="16">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="input-group">
													<input id="minimumQuantity" name="promotion.minimum_quantity" class="form-control" type="text" maxlength="9">
													<div class="input-group-addon">-</div>
													<input name="promotion.maximum_quantity" class="form-control" type="text" maxlength="9">
												</div>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="hidden-element form-group">
											...
											<div class="col-xs-4">
												<input id="conditionsAmount" name="promotion.conditions_amount" class="form-control" type="text" maxlength="16" disabled>
											</div>
										</div>
										<div class="hidden-element form-group">
											<label class="col-xs-2 control-label" for="creditAmount">${message("Promotion.creditAmount")}:</label>
											<div class="col-xs-4">
												<input id="creditAmount" name="promotion.credit_amount" class="form-control" type="text" maxlength="16" disabled>
											</div>
										</div>
										<div class="hidden-element form-group">
											<label class="col-xs-2 control-label" for="conditionsNumber">${message("Promotion.conditionsNumber")}:</label>
											<div class="col-xs-4">
												<input id="conditionsNumber" name="promotion.conditions_number" class="form-control" type="text" maxlength="9" disabled>
											</div>
										</div>
										<div class="hidden-element form-group">
											<label class="col-xs-2 control-label" for="creditNumber">${message("Promotion.creditNumber")}:</label>
											<div class="col-xs-4">
												<input id="creditNumber" name="promotion.credit_number" class="form-control" type="text" maxlength="9" disabled>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-xs-10 checkbox">
												<input id="isFreeShipping" name="promotion.is_free_shipping" type="text" value="false" data-toggle="checkbox-x">
												<label for="isFreeShipping" class="cbx-label">${message("Promotion.isFreeShipping")}</label>
												<input id="isCouponAllowed" name="promotion.is_coupon_allowed" type="text" value="true" data-toggle="checkbox-x">
												<label for="isCouponAllowed" class="cbx-label">${message("Promotion.isCouponAllowed")}</label>
												<input id="isEnabled" name="promotion.is_enabled" type="text" value="true" data-toggle="checkbox-x">
									...
									<div id="introduction" class="tab-pane">
										<textarea name="promotion.introduction" data-provide="editor"></textarea>
									</div>
								</div>
							</div>
