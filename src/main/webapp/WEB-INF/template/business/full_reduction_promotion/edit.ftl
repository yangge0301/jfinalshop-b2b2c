...
<head>
	...
	<title>${message("business.fullReductionPromotion.edit")} - Powered By JFinalShop</title>
								...
								<div class="tab-content">
									<div id="base" class="tab-pane active">
										<div class="form-group">
											...
											<div class="col-xs-4">
												<input id="name" name="promotion.name" class="form-control" type="text" value="${promotion.name}" maxlength="200">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label item-required" for="title">${message("Promotion.title")}:</label>
											<div class="col-xs-4">
												<input id="title" name="promotion.title" class="form-control" type="text" value="${promotion.title}" maxlength="200">
											</div>
										</div>
										<div class="form-group">
											<label class="col-xs-2 control-label">${message("Promotion.image")}:</label>
											<div class="col-xs-4">
												<input name="promotion.image" type="hidden" value="${promotion.image}" data-provide="fileinput" data-file-type="image">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="input-group" data-provide="datetimerangepicker" data-date-format="YYYY-MM-DD HH:mm:ss">
													<input id="beginDate" name="promotion.begin_date" class="form-control" type="text" value="[#if promotion.beginDate??]${promotion.beginDate?string("yyyy-MM-dd HH:mm:ss")}[/#if]">
													<div class="input-group-addon">-</div>
													<input name="promotion.end_date" class="form-control" type="text" value="[#if promotion.endDate??]${promotion.endDate?string("yyyy-MM-dd HH:mm:ss")}[/#if]">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="input-group">
													<input id="minimumPrice" name="promotion.minimum_price" class="form-control" type="text" value="${promotion.minimumPrice}" maxlength="16">
													<div class="input-group-addon">-</div>
													<input name="promotion.maximum_price" class="form-control" type="text" value="${promotion.maximumPrice}" maxlength="16">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-xs-4">
												<div class="input-group">
													<input id="minimumQuantity" name="promotion.minimum_quantity" class="form-control" type="text" value="${promotion.minimumQuantity}" maxlength="9">
													<div class="input-group-addon">-</div>
													<input name="promotion.maximum_quantity" class="form-control" type="text" value="${promotion.maximumQuantity}" maxlength="9">
												</div>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group[#if !promotion.conditionsAmount??] hidden-element[/#if]">
											...
											<div class="col-xs-4">
												<input id="conditionsAmount" name="promotion.conditions_amount" class="form-control" type="text" value="${promotion.conditionsAmount}" maxlength="16" [#if !promotion.conditionsAmount??] disabled[/#if]>
											</div>
										</div>
										<div class="form-group[#if !promotion.creditAmount??] hidden-element[/#if]">
											...
											<div class="col-xs-4">
												<input id="creditAmount" name="promotion.credit_amount" class="form-control" type="text" value="${promotion.creditAmount}" maxlength="16" [#if !promotion.creditAmount??] disabled[/#if]>
											</div>
										</div>
										<div class="form-group[#if !promotion.conditionsNumber??] hidden-element[/#if]">
											...
											<div class="col-xs-4">
												<input id="conditionsNumber" name="promotion.conditions_number" class="form-control" type="text" value="${promotion.conditionsNumber}" maxlength="9" [#if !promotion.conditionsNumber??] disabled[/#if]>
											</div>
										</div>
										<div class="form-group[#if !promotion.creditNumber??] hidden-element[/#if]">
											...
											<div class="col-xs-4">
												<input id="creditNumber" name="promotion.credit_number" class="form-control" type="text" value="${promotion.creditNumber}" maxlength="9" [#if !promotion.creditNumber??] disabled[/#if]>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-xs-10 checkbox">
												<input id="isFreeShipping" name="promotion.is_free_shipping" type="text" value="${promotion.isFreeShipping?string("true", "false")}" data-toggle="checkbox-x">
												<label for="isFreeShipping" class="cbx-label">${message("Promotion.isFreeShipping")}</label>
												<input id="isCouponAllowed" name="promotion.is_coupon_allowed" type="text" value="${promotion.isCouponAllowed?string("true", "false")}" data-toggle="checkbox-x">
												<label for="isCouponAllowed" class="cbx-label">${message("Promotion.isCouponAllowed")}</label>
												<input id="isEnabled" name="promotion.is_enabled" type="text" value="${promotion.isEnabled?string("true", "false")}" data-toggle="checkbox-x">
