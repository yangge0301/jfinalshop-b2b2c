...
public abstract class PaymentPlugin implements Comparable<PaymentPlugin> {
	 ...
	 * 默认支付视图名称
	 */
	public static final String DEFAULT_PAY_VIEW_NAME = "/shop/payment/pay.ftl";

	/**
	 * 默认支付结果视图名称
	 */
	public static final String DEFAULT_PAY_RESULT_VIEW_NAME = "/shop/payment/pay_result.ftl";
	...
	public void prePayHandle(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String paymentDescription, String extra, HttpServletRequest request, HttpServletResponse response, Controller controller) throws Exception {
		controller.redirect(paymentPlugin.getPayUrl(paymentPlugin, paymentTransaction));
	}
	 ...
	 * @throws Exception
	 */
	public abstract void payHandle(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String paymentDescription, String extra, HttpServletRequest request, HttpServletResponse response, Controller controller) throws Exception;
	...
	public void postPayHandle(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String paymentDescription, String extra, boolean isPaySuccess, HttpServletRequest request, HttpServletResponse response, Controller controller) throws Exception {
		controller.setAttr("paymentTransaction", paymentTransaction);
		controller.render(DEFAULT_PAY_RESULT_VIEW_NAME);
	}
	...
	public String getPrePayUrl(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String extra) {
		...
		return setting.getSiteUrl() + "/payment/pre_pay/" + paymentTransaction.getSn() + (StringUtils.isNotEmpty(extra) ? "-" + extra : "");
	}
	...
	public String getPayUrl(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String extra) {
		...
		Setting setting = SystemUtils.getSetting();
		return setting.getSiteUrl() + "/payment/pay/" + paymentTransaction.getSn() + (StringUtils.isNotEmpty(extra) ? "-" + extra : "");
	}
	...
	public String getPostPayUrl(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String extra) {
		...
		Setting setting = SystemUtils.getSetting();
		return setting.getSiteUrl() + "/payment/post_pay/" + paymentTransaction.getSn() + (StringUtils.isNotEmpty(extra) ? "-" + extra : "");
	}
