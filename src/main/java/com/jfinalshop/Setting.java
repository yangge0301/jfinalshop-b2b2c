...
public class Setting implements Serializable {
	...
	public String[] getCancelReasons() {
		return StringUtils.split(cancelReason, SEPARATOR);
	}
	...
	public void setCancelReason(String cancelReason) {
		if (cancelReason != null) {
			cancelReason = cancelReason.replaceAll("[,\\s]*,[,\\s]*", ",").replaceAll("^,|,$", "");
		}
	 ...
	 * @return 退款原因内容(数组)
	 */
	public String[] getRefundsReasons() {
		return StringUtils.split(refundsReason, SEPARATOR);
	}
	...
	public void setRefundsReason(String refundsReason) {
		if (refundsReason != null) {
			refundsReason = refundsReason.replaceAll("[,\\s]*,[,\\s]*", ",").replaceAll("^,|,$", "");
		}
