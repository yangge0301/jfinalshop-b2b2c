...
public abstract class BaseProductCategory<M extends BaseProductCategory<M>> extends Model<M> implements IBean {
	...
	public void setChildId(List<ProductCategory> parentId) {
		put("childId", parentId);
	}
	public List<ProductCategory> getChildId() {
		return get("childId");
	}

	public void setProInfo(List<Product> proinfo) {
		put("proinfo", proinfo);
	}
