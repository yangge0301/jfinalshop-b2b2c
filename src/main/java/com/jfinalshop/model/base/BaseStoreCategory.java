...
public abstract class BaseStoreCategory<M extends BaseStoreCategory<M>> extends Model<M> implements IBean {
	...
	public void setBail(java.math.BigDecimal bail) {
		set("bail", bail);
	}

	public java.math.BigDecimal getBail() {
		return get("bail");
	}
